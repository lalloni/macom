...
DATABASES = {
    ...
    'pg': {
        ...
        'NAME': 'macom', # Or path to database file if using sqlite3.
        'USER': 'macom', # Not used with sqlite3.
        'PASSWORD': 'macom', # Not used with sqlite3.
        'HOST': '10.20.109.213', # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '', # Set to empty string for default. Not used with sqlite3.
    }
}
